  ...
  $.ajax({
    ...
    success: function(data) {
     var product = JSON.parse(data);
            ...
            // row.find('#price_input').val(product.quantity);

      
      // Add code to populate the available quantity column
      row.find('#available_quantity').text(product.quantity);
...
$(document).ready(function() {
 ...
 $('#add_item').click(function() {
        var newRow = `<tr>
            ...
            <td><input class="form-group quantity_input" type="number" id="quantity_input" name="quantity[]" required></td>
            <td><input type="text" class="form-control" name="available_quantity[]" id= "available_quantity" readonly></td>
            <td><input type="number" name="total_price[]" id="total_price" class="form-group total-price-input" readonly></td>
            <td><button class="fa fa-trash text-danger" onclick="deleteRow(this.closest('tr'))"></button></td>
        </tr>`;
        ...
        <form method="post" action="updatebill.php">
            <div class="customer-details">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <!-- <label for="customer_name"><b>Customer Name:</b></label> -->
                        <b>Customer Name:</b><input type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $customerName; ?>" required><br>
                    </div>
                    <div class="col-sm-6">
                        <!-- <label for="mobile_no"><b>Mobile Number:</b></label> -->
                        <b>Mobile Number:</b><input type="text"  class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $mobileNo; ?>" required><br>
                    </div>
                    <div class="col-sm-6">
                        <!-- <label for="address"><b>Address:</b></label> -->
                        <b>Address:</b><textarea class="form-control" id="address" name="address" ><?php echo $address; ?></textarea>
                    </div>
                </div>
            </div><br><br>
            <div class="card" >
                    ...
                    <div class="row">
                        ...
                        <table id="items_table" class="table-responsive">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)) :
                                     $p_name = $row['product_name'];
                                      ...
                                      $qr = "SELECT quantity FROM products WHERE product_name = '$p_name' ";
                                      $qs = mysqli_query($con, $qr);
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control " id="brand" name="brand[]" value="<?php echo $row['brand']; ?>"   required></td>
                         <td><input type="number"  class="form-control quantity-input" id="quantity" name="quantity[]" value="<?php echo $row['quantity']; ?>"  data-per-piece-price="<?php echo $row['per_piece_price']; ?>" required></td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="available_quantity" id="available_quantity" value="<?php echo $qty; ?>" readonly></td>

                                    <td><input type="number" name="total_price[]" value="<?php echo $row['quantity']* $row['per_piece_price']; ?>" class="form-control total-price-input" readonly></td>
